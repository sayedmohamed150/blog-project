     ...
     <section className='relative bg-dark-hard px-5 text-left'>
        <div className='container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center'>
          <div className='col-span-12 lg:col-span-6'>
            ...
            <span className='font-bold italic text-[#B3BAC5] md:not-italic md:font-normal md:text-dark-light '>Get a response tomorrow</span> if you submit by 9pm today. If we received 
